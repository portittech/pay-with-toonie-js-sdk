...
<div class="main">
    <div class="left-side">
        <div class="card">
            ...
            <div class="icon">--</div>
            <h1 class="title">{formatAmountToDisplay(paymentDataBySessionId?.amount, paymentDataBySessionId?.currency) ?? "---"}</h1>
            <p class="subtitle">Checkout
                Total: {formatAmountToDisplay(paymentDataBySessionId?.amount, paymentDataBySessionId?.currency) ?? "---"}</p>
            <p class="subtitle">Reason: {paymentDataBySessionId?.reason ?? "---"}</p>
        </div>
    </div>
